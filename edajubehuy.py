...
class Player:
   ...
   def buyhouse(self,modprop,n):
      for colorlist in self.proplist:
         for prop in colorlist:
            if modprop.name == prop.name:
                if self.money>(n*prop.housecost):
                    prop.houses += n
                    self.money -= n*prop.housecost
               
   def sellhouse(self,modprop):
      for colorlist in self.proplist:
         for prop in colorlist:
            if modprop.name == prop.name:
               prop.houses -= 1
...
class Board:
 ...
 #  def __init__(self,name,boardpos,money,jailcards,jailtime,droll,piece,doublesacc,user):
      ...
      medit = Property("Old Kent Road","property",2,60,50,30,2,10,30,90,160,250,"bank","purple",0)
      self.boardlist.append(medit)
      cc1 = Communitychestspace("Community Chest","communitychestspace",3)
      self.boardlist.append(cc1)
      baltic = Property("Whitechapel Road","property",4,60,50,30,4,20,60,180,320,450,"bank","purple",0)
      self.boardlist.append(baltic)
      inctax = Taxspace("Income Tax","taxspace",5,200)
      self.boardlist.append(inctax)
      r1 = Railroad("Kings Cross Station","railroad",6,"bank")
      self.boardlist.append(r1)
      oriental = Property("The Angel, Islington","property",7,100,50,50,6,30,90,270,400,550,"bank","lightblue",0)
      self.boardlist.append(oriental)
      chance1 = Chancespace("Chance","chancespace",8)
      self.boardlist.append(chance1)
      vermont = Property("Euston Road","property",9,100,50,50,6,30,90,270,400,550,"bank","lightblue",0)
      self.boardlist.append(vermont)
      connave = Property("Pentonville Road","property",10,120,50,60,8,40,100,300,450,600,"bank","lightblue",0)
      self.boardlist.append(connave)
      jailspace = Freespace("Jail","freespace",11)
      self.boardlist.append(jailspace)
      stchar = Property("Pall Mall","property",12,140,100,70,10,50,150,450,625,750,"bank","pink",0)
      self.boardlist.append(stchar)
      ut1 = Utility("Electric Company","utility",13,"bank")
      self.boardlist.append(ut1)
      states = Property("Whitehall","property",14,140,100,70,10,50,150,450,625,750,"bank","pink",0)
      self.boardlist.append(states)
      virginia = Property("Northumberland Avenue","property",15,160,100,80,12,60,180,500,700,900,"bank","pink",0)
      self.boardlist.append(virginia)
      r2 = Railroad("Marylebone Station","railroad",16,"bank")
      self.boardlist.append(r2)
      stjames = Property("Bow Street","property",17,180,100,90,14,70,200,550,750,950,"bank","orange",0)
      self.boardlist.append(stjames)
      cc2 = Communitychestspace("Community Chest","communitychestspace",18)
      self.boardlist.append(cc2)
      tennessee = Property("Marlborough Street","property",19,180,100,90,14,70,200,550,750,950,"bank","orange",0)
      self.boardlist.append(tennessee)
      newyork = Property("Vine Street","property",20,200,100,100,16,80,200,600,800,1000,"bank","orange",0)
      self.boardlist.append(newyork)
      freepark = Freespace("Free Parking","freespace",21)
      self.boardlist.append(freepark)
      kentucky = Property("Strand","property",22,220,150,110,18,90,250,700,875,1050,"bank","red",0)
      self.boardlist.append(kentucky)
      chance2 = Chancespace("Chance","chancespace",23)
      self.boardlist.append(chance2)
      indiana = Property("Fleet Street","property",24,220,150,110,18,90,250,700,875,1050,"bank","red",0)
      self.boardlist.append(indiana)
      illinois = Property("Trafalgar Square","property",25,240,150,120,20,100,300,750,925,1100,"bank","red",0)
      self.boardlist.append(illinois)
      r3 = Railroad("Fenchurch St. Station","railroad",26,"bank")
      self.boardlist.append(r3)
      atlantic = Property("Leicester Square","property",27,260,150,130,22,110,330,800,975,1150,"bank","yellow",0)
      self.boardlist.append(atlantic)
      ventnor = Property("Coventry Street","property",28,260,150,130,22,110,330,800,975,1150,"bank","yellow",0)
      self.boardlist.append(ventnor)
      ut2 = Utility("Water Works","utility",29,"bank")
      self.boardlist.append(ut2)
      marvin = Property("Piccadilly","property",30,280,150,140,24,120,360,850,1025,1200,"bank","yellow",0)
      self.boardlist.append(marvin)
      gojail = Gotojailspace("Go To Jail","gotojailspace",31)
      self.boardlist.append(gojail)
      pacific = Property("Regent Street","property",32,300,200,150,26,130,390,900,1100,1275,"bank","green",0)
      self.boardlist.append(pacific)
      ncarol = Property("Oxford Street","property",33,300,200,150,26,130,390,900,1100,1275,"bank","green",0)
      self.boardlist.append(ncarol)
      cc3 = Communitychestspace("Community Chest","communitychestspace",34)
      self.boardlist.append(cc3)
      pennave = Property("Bond Street","property",35,320,200,160,28,150,450,1000,1200,1400,"bank","green",0)
      self.boardlist.append(pennave)
      r4 = Railroad("Liverpool St. Station","railroad",36,"bank")
      self.boardlist.append(r4)
      chance3 = Chancespace("Chance","chancespace",37)
      self.boardlist.append(chance3)
      parkplace = Property("Park Lane","property",38,350,200,175,35,175,500,1100,1300,1500,"bank","darkblue",0)
      self.boardlist.append(parkplace)
      luxtax = Taxspace("Super Tax","taxspace",39,75)
      self.boardlist.append(luxtax)
      boardwalk = Property("Mayfair","property",40,400,200,200,50,200,600,1400,1700,2000,"bank","darkblue",0)
      ...
      c4 = CommunityChestCard(ccdesc4,0,0,100,0,0,0,0)
      ...
      cdesc1 = "ADVANCE TO Trafalgar Square IF YOU PASS GO, COLLECT £200"
      c1 = ChanceCard(cdesc1,25,0,0,0,0,0,0)
      self.chancelist.append(c1)
      cdesc2 = "YOU ARE ASSESSED FOR STREET REPAIRS. £40 PER HOUSE."
      ...
      cdesc5 = "ADVANCE TO Pall Mall. IF YOU PASS GO, COLLECT £200"
      ...
      cdesc11 = "TAKE A RIDE to Kings Cross. ADVANCE TOKEN AND IF YOU PASS GO COLLECT £200"
      c11 = ChanceCard(cdesc11,6,0,0,0,0,0,0)
      self.chancelist.append(c11)
      cdesc12 = "GO BACK 3 SPACES"
            ...
            if currspace.owner == "bank":                           # if buyable
               ...
               if player.user == 1:
                  if player.money >= currspace.cost:                 # if user
                     buywhile = 0
                     while buywhile == 0:
                        choice = raw_input("NOBODY OWNS " + str(currspace.name) + ". WOULD YOU LIKE TO BUY IT? TYPE Y OR N.")
                        if choice in ["Y", "y"]:
                           player.addproperty(currspace)
      ...
      if player.jailtime > 0:
         ...
         if player.user == 1:
            ...
            if player.jailcards >= 0:
               jcwhile == 0
               while jcwhile == 0:
                  usejc = raw_input("Do you want to use a jailcard to get out? Type Y or N: ")
                  if usejc in ["Y", "y"]:
                     player.jailcards += -1
                     player.jailtime = 0
                     jcwhile = 1
                     ...
                     print("invalid input. Available answers are YES or NO.")

            if player.money >= 50:
               jailpaywhile = 0
               while jailpaywhile == 0:
                  jailpay = raw_input("Do you want to pay £50 to get out of jail? Type Y or N: ")
                  if jailpay in ["N", "n"]:
                     jailpaywhile = 1
                  if jailpay in ["Y", "y"]:
                     player.money += -50
            ...
            while jailrollwhile == 0:
               jailroll = raw_input("Do you want to try to roll doubles to get out of jail? Type Y or N: ")
               if jailroll in ["N", "n"]:
                  jailrollwhile = 1
               if jailroll in ["Y", "y"]:
                  die1 = random.randint(1,6)
         ...
         if "monopoly" in colorlist:
            for property in colorlist:
               if isinstance(property,Property):
                  if player.user == 0:
                     player.buyhouse(self, Property, 1)
                  if player.user == 1:
                     print(property.name + " has " + str(property.houses) + " houses.")
                     numOfHouses = input("How many more houses would you like to buy? ")
                     if numOfHouses>0:
                         player.buyhouse(Property, numOfHouses)
                     elif numOfHouses==0:
                         print("") # do nothing
                     else:
                         print("invalid input. Available answers are YES or NO (make sure caps is on).")      
...
#                           if player.user == 1:
#                              print(property.name + " has " + str(property.houses) + " houses.")
#                              buyhouseyn = raw_input("Do you want to buy another? Y or N: ")
#                              if buyhouseyn in ["N", "n"]:
#                                 housewhile = 1
#                              elif buyhouseyn in ["Y", "y"]:
#                                 player.money += -property.housecost
#                                 property.houses += 1
#                              else:
#                                 print("invalid input. Available answers are YES or NO (make sure caps is on).")      
...
#                           housewhile = 1
      if player.user == 1:
         ...
         if ownsprop or player.raillist or player.utlist:                            #DOES THIS WORK?
            ...
            while mortwhile == 0:
               mortyn = raw_input("Type Y or N.")
               if mortyn in ["Y", "y"]:
                  mortthis = raw_input("Please type the name of the property you own that you would like to mortgage.")
                  for colorlist in player.proplist:
                     for prop in colorlist:
                        if isinstance(prop,Property):
...
def main():
   ...
   playname = str(raw_input("PLEASE ENTER YOUR GAMEPIECE NAME: "))
